let idMax = require("../src/actions/createUserActions").idMax;
let dataValid = require("../src/actions/createUserActions").dataValid;
let checkMail = require("../src/actions/createUserActions").checkMail;
